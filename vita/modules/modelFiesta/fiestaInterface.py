...
class FieldLines(object):
    ...
    def readFiestaModel(self):
        ...
        output: self.R_limiter, the radial coordinates of the vessel limits
                ...
                self.psi_n,
                self.Br,        the radial magnetic field component
                self.Bz         the poloidal field component
                self.irod       the current in the rod
        '''
    ...
    def followFieldinPlane(self, p0, maxl=10.0, nr=2000, rtol=2e-10):
        ...
        X = solve_ivp(fun=dXdl, t_span=tuple([0.0, maxl]),
                      y0=p0, t_eval=dist_along_fieldline, rtol=rtol)
